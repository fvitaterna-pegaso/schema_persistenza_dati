...
create view v_reservations_journeys as
	...
	--select * from v_reservations_journeys
...
create view v_tickets_components_prices as
	...
	--select * from v_tickets_components_prices
...
create view v_passengers_journeys as
	...
	--select * from v_passengers_journeys

GO
--sp
if exists (select name from sys.views where name = 'sp_get_get_passenger_journey_by_pnr')
